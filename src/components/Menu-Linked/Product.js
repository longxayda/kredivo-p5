            ...
            <div className="glowing-border-container">
              <div className="glowing-border">
                ...
                <div>
                  ...
                  <div
                    style={{ border: "1px solid #FFFFFF", marginTop: "45px" }}
                  ></div>
                </div>
                <div></div>
                <div className="parent-container">
            ...
            <div>
              <div className="glowing-border-container">
                <div className="glowing-border">
                  ...
                  <div>
                    <p>
                      Thiết kế, phát triển và triển khai các ứng <br /> dụng
                      phần mềm <br /> Tích hợp các ứng dụng CNTT khác nhau{" "}
                      <br /> Bảo trì và hỗ trợ phần mềm
                    </p>
                  </div>
                  <div className="parent-container">
                    <div className="chi-tiet-form">
